...
usage:
  ...
  braids brief [--project NAME]          the state of play where you are
...
var known = []string{
	...
	"explain", "show", "doctor", "status", "brief", "promote", "merge", "hooks", "hook",
	"skill",
	"version", "help",
}
...
// updateOffer is the update command, or nil where braids has no installer it
// has actually run. The map only offers the key when this is not nil.
func updateOffer() func() *exec.Cmd {
